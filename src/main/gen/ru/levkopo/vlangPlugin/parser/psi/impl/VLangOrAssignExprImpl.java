...
public class VLangOrAssignExprImpl extends VLangExprImpl implements VLangOrAssignExpr {

  public VLangOrAssignExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull VLangVisitor visitor) {
    visitor.visitOrAssignExpr(this);
  }

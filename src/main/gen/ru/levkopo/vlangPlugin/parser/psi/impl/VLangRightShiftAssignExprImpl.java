...
public class VLangRightShiftAssignExprImpl extends VLangExprImpl implements VLangRightShiftAssignExpr {

  public VLangRightShiftAssignExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull VLangVisitor visitor) {
    visitor.visitRightShiftAssignExpr(this);
  }

...
public class VLangAtomicFileIFImpl extends ASTWrapperPsiElement implements VLangAtomicFileIF {

  public VLangAtomicFileIFImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VLangVisitor visitor) {
    visitor.visitAtomicFileIF(this);
  }

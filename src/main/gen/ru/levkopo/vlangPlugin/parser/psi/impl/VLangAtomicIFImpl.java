...
public class VLangAtomicIFImpl extends ASTWrapperPsiElement implements VLangAtomicIF {

  public VLangAtomicIFImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VLangVisitor visitor) {
    visitor.visitAtomicIF(this);
  }
